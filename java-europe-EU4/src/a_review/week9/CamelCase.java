...
public class CamelCase {
	...
	/*
	 * 
	 * * Create a method that will accept an ArrayList of words. Each element may be
	 * multiple words (which will be separated by a space and if that's the case
	 * make sure the element is following camel case rules. The camel case words
	 * should be added to a new ArrayList. Each character in your word should be
	 * lowercase except the first letter of each new word after the first word.
	 * 
	 * [ "java is fun", "lets go to the park" ] javaIsFun , letsGoToThePark
	 */
