...
public class String_Indexof {
	...
	public static void main(String[] args) {
		...
		// find position of '-' and check if space is right and left side
		...
		System.out.println("poistion of States: " + states);

		String word2 = "java, c++, python, tomcat, eclipe";
		// check if c++ is in the word2
		if (word2.contains("c++")) {
			System.out.println("it is " + word2.indexOf("c++") + ". in the " + "\"" + word2 + "\"");
		}
